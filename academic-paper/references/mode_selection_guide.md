...
**Expected Output**: Abstract (EN) + keywords
**Expected Duration**: Short
**Agents Used**: intake → abstract_agent
...
- Submitting under a covered policy target (ICLR, NeurIPS, Nature, Science, ACL, EMNLP, or a covered medical-publishing target: ICMJE, NEJM, The Lancet, JAMA, BMJ, PLOS, Frontiers, publisher-wide , journal-level )
