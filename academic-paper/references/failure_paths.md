...
| F6 | Poor abstract quality | Abstract omits key points or deviates from standards | Medium | Re-run abstract_agent |
...
**Detection Indicators**:
- Abstract omits key points covered in the draft
- Abstract omits important findings
- Keywords do not complement the title
- Word count seriously deviates from standards

**Handling Process**:
```
1. Compare the abstract structure and coverage against the draft
2. List inconsistencies
3. Rewrite based on the actual paper content as the standard
4. Ensure the rewritten abstract stays grounded in the draft
```
...
| F6 | abstract_agent writes independently based on the paper content as the standard |
