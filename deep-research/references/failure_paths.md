...
| F8 | Literature only available in other languages | full, lit-review | Medium | Switch search strategy |
...
### F8: Literature Only Available in Other Languages
...
**User Notification Message**:
> English-language literature on this topic is very limited, but literature in other languages is abundant. I will adjust the search strategy to include regional academic databases. Please note that citation conventions for literature in other languages may differ in international publications.

**Handling Steps**:
1. Switch search strategy to regional academic databases (e.g., Airiti Library, National Digital Library of Theses and Dissertations in Taiwan, CNKI)
2. Re-search using keywords in the languages of the available literature
3. Note the language distribution of the literature in the report
4. If the user needs an English report → provide suggestions for English citation format of literature in other languages
5. If the user needs to publish internationally → suggest finding comparable international cases

**Recovery Paths**:
- Literature in other languages is sufficient → continue workflow with clear language annotations
