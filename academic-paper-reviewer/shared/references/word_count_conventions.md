...
4. **Language-neutral.** For English / European languages, whitespace-split is the universal lower bound.
...
Some publishers and a small number of style guides count hyphenated compounds as multiple words. If the publisher explicitly states "hyphenated words count as separate words":
