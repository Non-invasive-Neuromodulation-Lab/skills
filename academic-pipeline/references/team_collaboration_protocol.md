...
Guidelines for coordinating multi-person academic research teams using the pipeline. The agent runs as a single-user session; this protocol documents the **human coordination layer** that wraps around pipeline executions.
...
- The agent runs as a single-user session; this protocol documents the HUMAN coordination layer
